 ...
 */
final class Version20250117123007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tareas DROP tipo');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tareas ADD tipo VARCHAR(255) NOT NULL');
    }
}
